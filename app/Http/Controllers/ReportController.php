...
class ReportController extends Controller
{
    ...
    public function dailySales(Request $request)
    {
        ...
        try {
            ...
            return back()->withErrors(['error' => 'Failed to generate daily sales report. Please try again.']);
        }
    ...
    public function monthlySales(Request $request)
    {
        ...
        try {
            ...
            Log::error('Failed to generate monthly sales report', [
                'month' => $month,
                'error' => $e->getMessage(),
            ]);

            return back()->withErrors(['error' => 'Failed to generate monthly sales report. Please try again.']);
        }
    ...
    public function products()
    {
        try {
            ...
            Log::error('Failed to generate product stock report', [
                'error' => $e->getMessage(),
            ]);

            return back()->withErrors(['error' => 'Failed to generate product stock report. Please try again.']);
        }
    ...
    public function buyers(Request $request)
    {
        try {
            ...
            Log::error('Failed to generate buyers report', [
                'error' => $e->getMessage(),
            ]);

            return back()->withErrors(['error' => 'Failed to generate buyers report. Please try again.']);
        }
    ...
    public function profit()
    {
        try {
            ...
            Log::error('Failed to generate profit report', [
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString(),
            ]);

            return back()->withErrors(['error' => 'Failed to generate profit report. Please try again.']);
        }
